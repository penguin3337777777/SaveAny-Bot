...
const (
	...
	CollectCancelled                                      Key = "collect.cancelled"
	CollectChecking                                       Key = "collect.checking"
	CollectCommand                                        Key = "collect.command"
	CollectCompleted                                      Key = "collect.completed"
	CollectCompletedSkipped                               Key = "collect.completed_skipped"
	CollectConfirming                                     Key = "collect.confirming"
	CollectDownloading                                    Key = "collect.downloading"
	CollectError                                          Key = "collect.error"
	CollectFailed                                         Key = "collect.failed"
	CollectItem                                           Key = "collect.item"
	CollectMoreActive                                     Key = "collect.more_active"
	CollectNeedUserbot                                    Key = "collect.need_userbot"
	CollectNoMatches                                      Key = "collect.no_matches"
	CollectPlanTooLarge                                   Key = "collect.plan_too_large"
	CollectProgress                                       Key = "collect.progress"
	CollectQueued                                         Key = "collect.queued"
	CollectRunning                                        Key = "collect.running"
	CollectSaving                                         Key = "collect.saving"
	CollectScanning                                       Key = "collect.scanning"
